  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'data-[size=default]:h-[26px] data-[size=sm]:h-[22px]',
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="text-muted-foreground transition-transform duration-150 ease-[var(--ease-out-quart)] group-data-[state=open]:rotate-180" />
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        'relative flex w-full cursor-pointer items-center gap-2 rounded-[16px] py-1 pr-7 pl-2',
